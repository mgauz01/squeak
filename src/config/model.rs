...
impl AsrModelId {
    ...
    ///
    /// All bundled Squeak models currently hit invalid `Slice` parameters on DirectML
    /// (ORT `80070057` / `E_INVALIDARG`). Keep CPU until a model is verified on DML.
...
"#;
    ...
    #[test]
    fn bundled_models_are_not_directml_compatible() {
