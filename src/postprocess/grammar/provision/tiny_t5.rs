...
pub const TINY_REQUIRED_FILES: &[&str] = &[
...
pub fn is_complete(dir: &Path) -> bool {
    is_complete_dir(dir, TINY_REQUIRED_FILES)
}
...
pub fn download(
    ...
    info!("Fetching tiny GEC model from HuggingFace ({HF_REPO})");
...
mod tests {
    ...
    #[test]
    fn incomplete_tiny_dir_fails_verification() {
        let dir = std::env::temp_dir().join("squeak-gec-tiny-incomplete");
